    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-cyan-50 to-cyan-900">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-cyan-900 mb-4 drop-shadow-lg">{t('contactTitle')}</h1>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            {/* Company Info Form */}
            <div className="bg-white/95 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-2xl">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">{t('companyInformation')}</h2>
              <p className="text-sm text-gray-600 mb-6">{t('pleaseProvideCompany')}</p>
