  ...
  return (
    <div className="group relative rounded-xl p-[1px] bg-gradient-to-b from-cyan-200 to-teal-200">
      <div className="h-full w-full rounded-xl bg-white p-6 shadow-sm transition-transform duration-200 group-hover:-translate-y-0.5">
        ...
        <p className="text-sm text-gray-600 mb-4 text-left">{bio}</p>
        <div className="flex items-center justify-between text-sm">
          <a
            href={`tel:${phone}`}
            className="inline-flex items-center gap-2 rounded-md border border-cyan-200 bg-white px-3 py-1.5 text-cyan-700 font-medium hover:bg-cyan-50"
          >
            <span>{t("call")}</span>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex gap-3">
                <a
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-md bg-white px-4 py-2 text-cyan-800 font-medium hover:bg-cyan-50"
                >
                  {t("workWithUs")}
                </a>
                <a
                  href="/services"
                  className="inline-flex items-center justify-center rounded-md border border-white/40 px-4 py-2 text-white font-medium hover:bg-white/10"
                >
                  {t("seeWhatWeDo")}
                </a>
              </div>
