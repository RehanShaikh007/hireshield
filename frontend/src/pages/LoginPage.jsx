  ...
  return (
    <div className="w-full mx-auto px-4 py-12 bg-gradient-to-t from-cyan-50 to-cyan-900 min-h-screen relative">
      ...
      <div className='mb-8'>
        ...
        <h1 className="text-3xl font-bold mb-2 text-center text-white drop-shadow-lg">{t('welcomeBack')}</h1>
      ...
      <div className="max-w-md mx-auto bg-white/95 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-2xl">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">{t('signIn')}</h2>
          <p className="text-gray-600 font-medium">{t('welcomeBackContinue')}</p>
        </div>
