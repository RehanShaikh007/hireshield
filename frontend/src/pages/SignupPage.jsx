...
const SignupPage = () => {
  ...
  const handleFinalSubmit = async (e) => {
    ...
    if (formData.password.length < 6) {
      setLoading(false);
      setTimeout(() => toast.error('Password must be at least 6 characters long'), 50);
      return;
    }
  ...
  return (
    <div className="w-full mx-auto px-4 py-12 bg-gradient-to-t from-cyan-50 to-cyan-900 min-h-screen relative">
      ...
      <div className="max-w-md mx-auto bg-white/95 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="flex items-center justify-center mb-6">
          <div className="flex items-center">
            ...
            <button
              ...
              className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-200 cursor-pointer ${
                currentStep >= 2 ? 'bg-cyan-600 text_white hover:bg-cyan-700' : 'bg-gray-300 text-gray-600 hover:bg-gray-400'
              }`}
            >
              2
            </button>
        ...
        {currentStep === 1 ? (
          <form onSubmit={handleNextStep} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={handleChange}
                  className="w-full rounded-xl border-2 border-gray-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200 bg_white/80 backdrop-blur-sm" 
            ...
            <div>
                            <label className="block text_sm font-semibold text-gray-700 mb-2">{t('emailAddress')}</label>
              <input 
                type="email" 
                name="email"
          ...
          <form onSubmit={handleFinalSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input 
                ...
                onChange={handleChange}
                className="w-full rounded-xl border-2 border-gray-200 px-4 py-3 focus:outline_none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200 bg-white/80 backdrop-blur-sm" 
