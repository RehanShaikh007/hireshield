...
const Stat = ({ value, label }) => (
  <div className="p-3 sm:p-4 rounded-lg bg-white shadow-sm text-center">
    <div className="text-lg sm:text-xl md:text-2xl font-semibold text-cyan-700">
      {value}
    </div>
  ...
  return (
    <div>
          ...
          <div className="container mx-auto px-4 py-16 sm:py-20 md:py-24 lg:py-28">
            ...
            <div className="block md:hidden text-center">
              ...
              <div className="mb-4 inline-flex items-center gap-1 rounded-full border border-cyan-200/70 bg-white/70 px-3 py-2 shadow-sm backdrop-blur-sm text-xs">
                ...
                <span className="text-cyan-600 animate-pulse [animation-delay:200ms]">
                  •
                </span>
                <span className="font-medium text-cyan-800">
                  {t("verified")}
              ...
              <div className="rounded-xl border border-cyan-100/70 bg-white/70 p-4 backdrop-blur-sm mb-6">
                <p className="text-sm leading-relaxed text-gray-800 mb-3">
                  ...
                  we believe that every great hire begins with{" "}
                  <span className="bg-cyan-100/60 text-cyan-900 px-1 py-0.5 rounded">
                    {t("trust")}
                  </span>
                  . As a next-gen background verification company, we specialize
                  in delivering{" "}
                  <span className="bg-cyan-50 text-cyan-900 px-1 py-0.5 rounded">
                    {t("fast")}
                  </span>
                  ,{" "}
                  <span className="bg-cyan-50 text-cyan-900 px-1 py-0.5 rounded">
                ...
                <p className="text-sm leading-relaxed text-gray-800">
                  Our tech-enabled platform ensures that every candidate is
                  vetted with{" "}
                  <span className="bg-cyan-50 text-cyan-900 px-1 py-0.5 rounded">
                    {t("precision")}
                  </span>
              ...
              <div className="flex flex-col gap-3">
                <Link
                  to="/signup"
                  className="px-5 py-3 rounded-md bg-cyan-700 text-white font-medium hover:bg-cyan-800"
                >
                  {t("getVerified")}
                </Link>
                <Link
                  to="/services"
                  className="px-5 py-3 rounded-md bg-white text-cyan-800 font-medium border border-cyan-200 hover:bg-cyan-50"
                >
                  {t("learnMore")}
                </Link>
              </div>
            ...
            <div className="hidden md:grid grid-cols-2 gap-10 items-center">
              <div>
                ...
                <div className="rounded-xl border border-cyan-100/70 bg-white/70 p-5 backdrop-blur-sm">
                  <p className="text-[1.05rem] lg:text-[1.125rem] leading-relaxed text-gray-800 mb-3">
                    ...
                    . As a next-gen background verification company, we
                    ...
                    screening services that empower organizations to make
                    confident hiring decisions.
                  </p>
                  <p className="text-[1.05rem] lg:text-[1.125rem] leading-relaxed text-gray-800">
                    Whether you're a startup scaling rapidly or an enterprise
                    managing complex onboarding workflows, our tech-enabled
                    platform ensures that every candidate is vetted with{" "}
                    <span className="bg-cyan-50 text-cyan-900 px-1 py-0.5 rounded">
                      {t("precision")}
                    </span>
                    ,{" "}
              ...
              <div>
                <div className="relative w-full h-96 lg:h-[35rem] flex items-center justify-center">
                  <div
                    aria-hidden
                    className="absolute h-72 w-72 lg:h-72 lg:w-72 rounded-full bg-cyan-200/50 blur-2xl"
                  />
      ...
      <section className="container mx-auto px-4 py-12 sm:py-16">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-6 text-center sm:text-left">
          {t("whyChooseUs")}
        </h2>
          ...
          {[
            {
              ...
              desc: t("fastReliableDesc"),
              Icon: FiZap,
            },
            {
              title: t("compliantByDesign"),
              desc: t("compliantByDesignDesc"),
              Icon: FiShield,
            },
            {
              title: t("scalesWithYou"),
              desc: t("scalesWithYouDesc"),
              Icon: FiTrendingUp,
            },
          ].map((f) => (
            <div
              key={f.title}
              className="group relative rounded-xl p-[1px] bg-gradient-to-b from-cyan-200 to-teal-200"
            >
        ...
        <div className="relative grid gap-6 md:grid-cols-3">
          ...
          {[
            ...
            >
              ...
              <h3 className="mt-2 font-semibold mb-2 text-cyan-900">
                {i.step}
              </h3>
      ...
      <section className="relative">
        <div
          aria-hidden
          className="absolute inset-0 -z-10 bg-gradient-to-r from-cyan-50 to-white"
        />
        <div className="container mx-auto px-4 py-16">
          <div className="rounded-2xl p-8 md:p-10 bg-gradient-to-r from-cyan-700 to-teal-600 text-white shadow-lg">
            <h3 className="text-xl md:text-2xl font-semibold mb-2">
              {t("buildSaferWorkplaces")}
            </h3>
            <p className="text-white/90 mb-6">{t("oneVerifiedProfile")}</p>
            <div className="flex gap-3 flex-wrap">
              <Link
                to="/signup"
                className="px-5 py-3 rounded-md bg-white text-cyan-800 font-medium hover:bg-cyan-50"
              >
                {t("getStarted")}
              </Link>
              <Link
                to="/contact"
                className="px-5 py-3 rounded-md border border-white/40 text-white font-medium hover:bg-white/10"
              >
                {t("talkToUs")}
              </Link>
            </div>
