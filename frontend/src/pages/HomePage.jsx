      ...
      <section className="container mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-sm border p-6 md:p-8">
          <div className="flex items-center justify-between flex-wrap gap-4 mb-4">
            <h2 className="text-xl md:text-2xl font-semibold">Verification Services</h2>
            <div className="flex gap-3">
              <Link to="/services" className="px-4 py-2 rounded-md bg-white text-cyan-800 font-medium border border-cyan-200 hover:bg-cyan-50">Explore Services</Link>
              <Link to="/dashboard" className="px-4 py-2 rounded-md bg-cyan-700 text-white font-medium hover:bg-cyan-800">Apply Now</Link>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-lg border">
              <h3 className="font-semibold mb-1">Address Verification</h3>
              <p className="text-sm text-gray-600">Aadhaar, passport, rental agreement</p>
            </div>
            <div className="p-4 rounded-lg border">
              <h3 className="font-semibold mb-1">Employment</h3>
              <p className="text-sm text-gray-600">Payslips, appointment letter, relieving letter</p>
            </div>
            <div className="p-4 rounded-lg border">
              <h3 className="font-semibold mb-1">Education & IDs</h3>
              <p className="text-sm text-gray-600">Certificates, 10th marks, PAN, voter ID</p>
            </div>
          </div>
        </div>
      </section>
