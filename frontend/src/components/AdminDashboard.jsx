                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="block w-15 pr-8 pl-3 py-2 border border-white/20 rounded-lg leading-5 bg-cyan-700 backdrop-blur-sm text-white focus:outline-none focus:ring-1 focus:ring-cyan-600 focus:border-cyan-700 sm:text-sm appearance-none"
                    >
              ...
              <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 transform transition-all">
                ...
                <div className="px-6 py-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-300 mb-6">
                      Are you sure you want to delete the contact submission
                      from{" "}
                      <span className="font-semibold text-white">
