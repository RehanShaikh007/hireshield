...
const SuperAdminDashboard = () => {
  const { user, getAllUsers, createAdmin, updateUserRole, updateUserStatus, deleteUser } = useAuth();
  const { t } = useLanguage();
      ...
      <div className="border-white/10">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4 sm:py-6">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-white drop-shadow-lg text-center sm:text-left">{t('superAdminDashboard')}</h1>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-6 hover:bg-white/15 transition-all duration-300 hover:scale-105 text-white">
              ...
              {isGoogleUser && (
                <div className="mt-4 text-sm text-gray-300 bg-white/10 backdrop-blur-sm p-3 rounded-lg border border-white/20">
                  <p className="font-medium text-white mb-1">🔐 Google Account</p>
            ...
            <div className="px-6 py-4 border-b border-white/20">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <label htmlFor="usersPerPage" className="text-sm font-medium text-gray-300">
                    Show:
                  </label>
                  <select
                    id="usersPerPage"
                        ...
                        <tr key={userItem._id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <select
                              ...
                              className={`px-2 py-1 rounded-full text-xs font-medium ${getRoleBadge(userItem.role)} border-0`}
